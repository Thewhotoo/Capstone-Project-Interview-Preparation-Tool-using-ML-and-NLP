...
the A1 checkpoint reproduces the REPORTED A1 test-set QWK numbers (TC
0.2734, Depth 0.8921, Relevance 0.2325, Grounding 0.4983, mean 0.4741)
before trusting it for V4 inference. Same methodology as
`sanity_check_v3_checkpoint.py`, pointed at the A1 checkpoint instead.
...
def main():
    ...
    print("\n--- Reproduced A1 test metrics (should closely match reported: TC 0.2734, Depth 0.8921, Rel 0.2325, Grounding 0.4983, mean 0.4741) ---")
    ks = []
    for dim in CANONICAL_DIMENSION_KEYS:
